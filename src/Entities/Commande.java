...
public class Commande {
    ...
    public Commande(int id, Date date_emission, String etat_commande, int id_user, double prixTotal) {
        this.id=id;
    ...
    public String toString() {
        return "Commande{" + "id=" + id +  ", etat_commande=" + etat_commande +", date d'emissiont=" + date_emission +   ", id_user=" + id_user + ", prixTotal=" + prixTotal + '}';
    }
